...
CREATE TABLE zmt_admin_auth (
  ...
  update_at datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (id)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='管理员权限表';
...
CREATE TABLE zmt_shop (
  ...
  telephone varchar(20) DEFAULT NULL COMMENT '联系方式',
  region_id int(11) DEFAULT '0' COMMENT '店铺地址',
...
INSERT INTO `zmt_admin_users` VALUES ('2','admin','93be24541521e6fe437c5ca3dfaf5a82','王小明','2018-06-12 16:15:00','2018-06-12 16:15:00','127.0.0.1','2018-06-12 16:15:00','0');
...
/* 转存表中的数据:zmt_shop*/ 
INSERT INTO `zmt_shop` VALUES ('1','0','卓牧通','admin','93be24541521e6fe437c5ca3dfaf5a82','王小明','17853391882','0','','山东省潍坊市','','1','2018-06-12 16:15:00','2018-06-12 16:15:00','2018-06-13 22:37:36','0','0.0000','0.0000','1');
